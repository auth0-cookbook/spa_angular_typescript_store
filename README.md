...
The values of `AUTH0_AUDIENCE` and `API_SERVER_ROOT_URL` require that you have set up any version of the Auth0 Eats Customers API server.
...
- The value of `API_SERVER_ROOT_URL` is the value of your Auth0 Eats Customer API server root URL.
